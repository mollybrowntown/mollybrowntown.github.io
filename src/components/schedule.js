...
toggleTabs(){
  if(this.state.activeTab === "current"){
        return(
          <Card.Body>
    {/* <Card.Title>Molly Brown concludes the 2019 season T-5th at USAU Nationals</Card.Title> */}
    <Card.Text>
...
<hr/>
    ...
    <MobileView>
    <h3 className="schedule-header">2019 Schedule</h3><hr/>
    <Card className="schedule-grid">
    <Card.Header>
      <Nav variant="tabs" defaultActiveKey="current" onSelect={(eventKey) => this.setState({activeTab: eventKey})}>
        <Nav.Item>
